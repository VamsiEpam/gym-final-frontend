...
export class TrainerNavbarComponent implements OnInit{
  ...
  addTraining() {
    this.router.navigate(['/trainer/add-training'],{state : {trainerProfile : this.trainerProfile}})
  }
  ...
  homepage() {
    this.router.navigate(['trainer'],{state : {trainerProfile : this.trainerProfile}})
  }
